...
const buildGrammar = () => {
	let text = fs.readFileSync(path.join(__dirname, 'markdown-captions.tmLanguage.base.yaml'), "utf8");
	...
	fs.writeFileSync(path.join(__dirname, 'syntaxes', 'markdown-captions.tmLanguage'), out);
};
